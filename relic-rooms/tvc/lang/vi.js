...
window.__TVC_LANG_PACKS__.vi = {
  "ui": {
    ...
    "welcome.eyebrow": "Cuộc điều tra dành cho học sinh tiểu học lớp lớn và trung học cơ sở",
    "welcome.title": "Lớp học đã biến mất",
    "welcome.subtitle": "Bạn có thể khám phá những cách dạy học mà thời gian đã bỏ lại phía sau không?",
    "welcome.body": "Lớp học đã thay đổi rất nhiều trong hai trăm năm qua. Một số cách làm từng được xem là bình thường đã hoàn toàn biến mất khỏi trường học. Hãy bước vào lớp học đã biến mất để điều tra chín di vật giảng dạy từ những năm 1800 và khám phá xem cuối cùng điều gì đã thay thế chúng.",
    "welcome.enter": "Bước vào ngôi trường",
    "directions.eyebrow": "Hướng dẫn cho học sinh",
    "directions.title": "Cách điều tra mỗi hiện vật",
    "directions.body1": "Hãy đến thăm từng hiện vật và nghiên cứu hình ảnh cùng các manh mối. Trước tiên, hãy xác định cách dạy học hoặc công cụ đó. Tiếp theo, hãy quyết định nó nhằm giải quyết vấn đề gì. Cuối cùng, hãy chọn cách làm hoặc công nghệ mà cuối cùng đã thay thế nó.",
    "directions.body2": "Bạn có thể xem lại các hiện vật trước khi nộp câu trả lời cuối cùng.",
    "directions.step1title": "Xác định nó",
    "directions.step1body": "Dùng các manh mối và khu vực hình ảnh để quyết định cách làm hoặc công cụ đó là gì.",
    "directions.step2title": "Tìm mục đích của nó",
    "directions.step2body": "Chọn vấn đề mà cách làm này nhằm giải quyết.",
    "directions.step3title": "Truy tìm thứ thay thế nó",
    "directions.step3body": "Chọn thứ mà lớp học ngày nay dùng để thay thế nó.",
    "directions.start": "Bắt đầu điều tra",
    "list.eyebrow": "Chín di vật lớp học",
    "list.title": "Chọn một hiện vật để điều tra",
    "list.body": "Mỗi bàn học mở ra một cuộc điều tra ba phần. Các hiện vật đã hoàn thành vẫn có thể xem lại.",
    "list.finish": "Xem điểm số cuối cùng của tôi",
    "exhibit.back": "Quay lại các hiện vật",
    "exhibit.label": "Hiện vật {n}",
    "exhibit.mystery": "Cách làm bí ẩn",
    "exhibit.check": "Kiểm tra bài điều tra của tôi",
    ...
    "placeholder.alt": "Hình ảnh cho Hiện vật {n}. Nếu không có hình ảnh tùy chỉnh xuất hiện, hãy dùng các manh mối và thêm một tệp tại {path}.",
    "questions.identify": "Đây là cách dạy học hoặc công cụ lớp học nào?",
    "questions.purpose": "Nó nhằm giải quyết vấn đề gì?",
    "questions.replacement": "Điều gì đã thay thế nó trong lớp học ngày nay?",
    "label.identify": "Xác định",
    ...
    "feedback.recorded": "Đã ghi lại bài điều tra. Bạn đạt được {points} trên {max} điểm cho hiện vật này.",
    "feedback.attempt": "Đã ghi lại lần thử {n}. Hãy kiểm tra các mục được đánh dấu “Cần xem lại” và thử thêm một lần nữa.",
    "reveal.title": "Tiết lộ hiện vật",
    "reveal.relic": "Cách làm",
    ...
    "score.title": "Kết quả Lớp học đã biến mất của bạn",
    "score.review": "Xem lại các hiện vật",
    "score.reflection": "Suy ngẫm của thám tử lịch sử",
    "score.tryagain": "Thử lại",
    "level.1": "Nhà du hành thời gian lịch sử",
    "level.2": "Nhà sử học lớp học",
    "level.3": "Thám tử ngôi trường",
    "level.4": "Học viên lịch sử đang rèn luyện",
    "level.msg1": "Bạn đã truy tìm những di vật lớp học này xuyên thời gian với độ chính xác của chuyên gia.",
    "level.msg2": "Bạn đã khám phá được bằng chứng vững chắc về cách những cách làm cũ định hình lớp học ngày nay.",
    "level.msg3": "Bạn đã phát hiện nhiều manh mối quan trọng và kết nối được vài di vật với thứ thay thế chúng.",
    "level.msg4": "Bạn đang xây dựng kỹ năng điều tra của mình. Hãy xem lại các hiện vật và quan sát kỹ các manh mối.",
    "reflection.eyebrow": "Suy ngẫm của thám tử lịch sử",
    "reflection.title": "Giải thích những gì bạn đã khám phá",
    "reflection.relicLabel": "Cách làm trong lớp học mà tôi đã chọn",
    "reflection.relicChoose": "Chọn một cách làm",
    "reflection.purposeLabel": "Vấn đề mà nó nhằm giải quyết",
    "reflection.limitationLabel": "Một hạn chế mà nó có",
    "reflection.replacementLabel": "Cách làm hoặc công cụ đã thay thế nó",
